    ...
    <div class="mx-auto max-w-2xl">
      <div class="mb-12">
        ...
        <p class="mt-4 text-base/7 text-gray-600">
          Email:
          <a
            href="mailto:support@getnovelize.com"
            class="font-semibold text-orange-600 hover:text-orange-500"
            >support@getnovelize.com</a
          >
        </p>
      ...
      >
          ...
          <div>
            ...
            <div class="mt-2.5">
              <input
                ...
                id="name"
                required
                class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-orange-600"
              />
            </div>
          </div>
          <div>
        ...
        <div class="mt-10">
          <button
            type="submit"
            class="block w-full rounded-md bg-orange-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-orange-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
          >
            Send Message
          </button>
        </div>
