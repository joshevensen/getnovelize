  ...
  <UiContainer size="md">
    <div class="mx-auto max-w-5xl">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-5 lg:gap-12">
        <div
          class="bg-parchment-50 rounded-3xl ring-1 ring-gray-200 p-8 sm:p-10 lg:col-span-3"
        >
        ...
        <div class="flex flex-col justify-start lg:col-span-2 pt-10">
          <p class="text-lg/7 text-gray-600">
            We don't have a big call center or outsourced support. It's just us
            — the same people who build and run Novelize.
          </p>
          <p class="mt-4 text-lg/7 text-gray-600">
            We try to answer within 24 hours, but sometimes it might take a
            little longer.
          </p>
        </div>
      </div>
