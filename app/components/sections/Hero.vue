<template>
  <UiContainer class="pt-10 pb-24 sm:pb-32 lg:flex lg:pt-30" variant="none">
    <div class="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-24">
      <h1
    ...
    <div
      class="mx-auto flex max-w-2xl sm:mt-24 lg:mt-0 lg:mr-0 lg:ml-10 lg:max-w-none lg:flex-none xl:ml-32"
    >
