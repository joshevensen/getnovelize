export default defineAppConfig({
  seo: {
    about: {
      title: "About Novelize - Our Story",
      description:
    ...
    home: {
      title: "Novelize - Finish Your Novel Without Distractions",
      description:
    ...
    pricing: {
      title: "Pricing - One Simple Plan | Novelize",
      description:
    ...
    docs: {
      title: "Writing Articles & Tips | Novelize",
      description:
